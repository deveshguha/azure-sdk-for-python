...
class AzureDeploymentManager(object):
    ...
    :vartype service_topologies: deploymentmanager.operations.ServiceTopologiesOperations
    :ivar services: Services operations
    :vartype services: deploymentmanager.operations.ServicesOperations
    :ivar service_units: ServiceUnits operations
    :vartype service_units: deploymentmanager.operations.ServiceUnitsOperations
    :ivar steps: Steps operations
    :vartype steps: deploymentmanager.operations.StepsOperations
    :ivar rollouts: Rollouts operations
    :vartype rollouts: deploymentmanager.operations.RolloutsOperations
    :ivar artifact_sources: ArtifactSources operations
    :vartype artifact_sources: deploymentmanager.operations.ArtifactSourcesOperations
    :ivar operations: Operations operations
    :vartype operations: deploymentmanager.operations.Operations
    ...
    def __init__(
        ...
        self.config = AzureDeploymentManagerConfiguration(subscription_id, base_url)
