...
class RolloutStep(Model):
    ...
    :vartype operation_info: ~deploymentmanager.models.StepOperationInfo
    ...
    :vartype resource_operations:
     list[~deploymentmanager.models.ResourceOperation]
    :ivar messages: Supplementary informative messages during rollout.
    :vartype messages: list[~deploymentmanager.models.Message]
    """
    ...
    def __init__(self, name, step_group=None):
        super(RolloutStep, self).__init__()
        self.name = name
        self.status = None
