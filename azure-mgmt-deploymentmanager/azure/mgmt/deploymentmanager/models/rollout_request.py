...
class RolloutRequest(TrackedResource):
    ...
    def __init__(self, location, identity, build_version, target_service_topology_id, step_groups, tags=None, artifact_source_id=None):
        super(RolloutRequest, self).__init__(tags=tags, location=location)
