...
class Service(ServiceProperties):
    ...
    :param service_units: The detailed information about the units that make
     up the service.
    :type service_units: list[~deploymentmanager.models.ServiceUnit]
    """
    ...
    def __init__(self, target_location, target_subscription_id, name=None, service_units=None):
        super(Service, self).__init__(target_location=target_location, target_subscription_id=target_subscription_id)
        self.name = name
