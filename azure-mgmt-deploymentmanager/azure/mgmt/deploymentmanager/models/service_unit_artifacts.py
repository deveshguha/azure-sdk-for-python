...
class ServiceUnitArtifacts(Model):
    ...
    def __init__(self, template_uri=None, parameters_uri=None, template_artifact_source_relative_path=None, parameters_artifact_source_relative_path=None):
        super(ServiceUnitArtifacts, self).__init__()
