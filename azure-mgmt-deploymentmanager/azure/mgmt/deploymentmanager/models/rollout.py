...
class Rollout(TrackedResource):
    ...
    :type identity: ~deploymentmanager.models.Identity
    ...
    :param target_service_topology_id: The resource Id of the service topology
     from which service units are being referenced in step groups to be
     deployed.
    :type target_service_topology_id: str
    :param step_groups: The list of step groups that define the orchestration.
    :type step_groups: list[~deploymentmanager.models.Step]
    ...
    :vartype operation_info: ~deploymentmanager.models.RolloutOperationInfo
    :ivar services: The detailed information on the services being deployed.
    :vartype services: list[~deploymentmanager.models.Service]
    """
    ...
    def __init__(self, location, build_version, target_service_topology_id, step_groups, tags=None, identity=None, artifact_source_id=None):
        super(Rollout, self).__init__(tags=tags, location=location)
