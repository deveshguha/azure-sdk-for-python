...
class Step(Model):
    ...
    :param pre_deployment_steps: The list of steps to be run before deploying
     the target.
    :type pre_deployment_steps: list[~deploymentmanager.models.PrePostStep]
    :param deployment_target_id: The resource Id of service unit to be
    ...
    :param post_deployment_steps: The list of steps to be run after deploying
     the target.
    :type post_deployment_steps: list[~deploymentmanager.models.PrePostStep]
    """
    ...
    def __init__(self, name, deployment_target_id, depends_on_step_groups=None, pre_deployment_steps=None, post_deployment_steps=None):
